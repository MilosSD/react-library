          ...
          <div
            ...
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                Whether is to learn a new skill or grow a within one, 
          ...
          >
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                Luv 2 Read students! We are diligent about our bok selection 
            ...
            <div className="col-img-left">
              <div className="mt-2">
                ...
                <p className="lead">
                  ...
                  reading. Ehether is to learn a new skill or grow a within one,
                  we will be able to provide top content for you!
                </p>
                <a className="btn main-color btn-lg text-white" href="#">
                  Sign Up{" "}
