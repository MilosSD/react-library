    ...
    useEffect( () => {
        const fetchUserHistory = async () => {
            if (authState && authState.isAuthenticated) {
                ...
                const historyRepsonseJson = await historyResponse.json();

                setHistories(historyRepsonseJson._embedded.histories);
                setTotalPages(historyRepsonseJson.page.totalPages);
            }
